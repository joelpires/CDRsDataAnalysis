...
def main():
    ...
    try:
        ...
        query = "SELECT * FROM public.altice_finalroutes_stats_typemode WHERE city='Aveiro'"
        cur.execute(query)
        ...
        query = "SELECT * FROM public.altice_finalroutes_stats_travel_modes WHERE city='Aveiro'"
        cur.execute(query)
